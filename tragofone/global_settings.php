...
<div class="tg-wrap">
	<div class="tg-head"><div><h2>Global Tragofone Settings</h2><div class="tg-subtle">Optional shared defaults controlled by FusionPBX Superadmins.</div></div><div class="tg-actions"><span class="tg-state">Superadmin only</span><a class="btn btn-default" href="index.php">Overview</a></div></div>
