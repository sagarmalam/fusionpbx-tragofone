...
$selected_count = 0; foreach ($extensions as &$extension) { $extension['effective_sync'] = $extension['sync_enabled'] === null ? $default_sync : tragofone_normalizer::boolean($extension['sync_enabled']); if ($extension['effective_sync']) { $selected_count++; } } unset($extension);
...
<div class="tfn-shell">
	...
	<table class="tf-table"><thead><tr><th style="width:65px">Sync</th><th>Extension</th><th>FusionPBX</th><th>Tragofone mapping</th><th>Last synchronized</th></tr></thead><tbody id="extension_rows">
	...
	<?php if ($extensions === []) { ?><tr><td colspan="5"><div class="tfn-empty"><b>No extensions in this domain.</b><br>Verify the selected domain or create a SIP extension under Accounts → Extensions.</div></td></tr><?php } ?>
	</tbody></table></div>
