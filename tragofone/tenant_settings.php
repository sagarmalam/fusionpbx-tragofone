...
<div class="tf-wrap">
	<div class="tf-head"><div><h2>Tragofone Tenant Settings</h2><div class="tf-subtle">Configure provisioning for <b><?= escape($_SESSION['domain_name'] ?? $domain_uuid) ?></b></div></div><div class="tf-actions"><span class="tf-state <?= $status_class ?>"><?= $status_label ?></span><a class="btn btn-default" href="index.php">Overview</a><?php if (permission_exists('tragofone_extension_sync_view')) { ?><a class="btn btn-primary" href="extension_sync.php">Manage Extensions</a><?php } ?></div></div>
