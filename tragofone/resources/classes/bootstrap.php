...
foreach ([
	...
	'tragofone_selfcare_policy.php', 'tragofone_selfcare_settings.php', 'tragofone_selfcare_theme.php', 'tragofone_selfcare_launch.php', 'tragofone_selfcare_provisioning.php',
